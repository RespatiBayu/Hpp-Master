...
- `admin`
  Bisa mengelola user `staff`, mengatur user role, dan melakukan override show/hide menu untuk staff di bisnis aktif.
- `staff`
...
- user role dan override show/hide menu untuk staff di bisnis aktif
